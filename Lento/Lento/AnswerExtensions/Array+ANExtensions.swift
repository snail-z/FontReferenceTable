...
public extension Array {
    ...
    func catalogues<T>(_ condition: (_ element: Element) -> String?, map: ((aKey: String, elements: [Element])) -> T) -> [T] {
        var temps = [T]()
    ...
    private func catalogued(_ condition: (_ element: Element) -> String?, forEach: ((aKey: String, elements: [Element])) -> Void?) {
    ...
    private func catalogued(generator: inout [Element], _ closure1: (_ sender: Element) -> String?, _ closure2: ([String: [Element]]) -> Void?) {
