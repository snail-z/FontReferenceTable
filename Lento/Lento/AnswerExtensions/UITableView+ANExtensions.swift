...
public extension UITableView {
    ...
    /// 消除UITableView分组上的间隙
    /// 全局设置：UITableView.appearance().sectionHeaderTopPadding = 0
    func fixSectionHeaderTopPadding() {
    ...
    func register<T: UITableViewHeaderFooterView>(headerFooterViewClassWith desc: T.Type) {
